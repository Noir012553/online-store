...
const LOCAL_UI_FALLBACKS: Partial<Record<Locale, Record<string, string>>> = {
  vi: {
    ...
    minutes_label: 'Phút',
    seconds_label: 'Giây',
    flash_deal_title: 'Khuyến Mại Nhanh',
    ...
    demo_admin: 'Admin: admin@example.com / password',
    demo_user: 'Người dùng: user@example.com / password',
  ...
  en: {
    ...
    demo_admin: 'Admin: admin@example.com / password',
    demo_user: 'User: user@example.com / password',
