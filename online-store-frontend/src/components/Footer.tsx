              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-400">
                    ...
                    <li>
                      <Link
                        href="/products/laptop-van-phong"
                        className="hover:text-red-500 hover:translate-x-1 inline-block transition-all duration-300"
                      >
                        Laptop Văn phòng
                      </Link>
                    ...
                    <li>
                      <Link
                        href="/products/laptop-sinh-vien"
                        className="hover:text-red-500 hover:translate-x-1 inline-block transition-all duration-300"
                      >
                        Laptop Sinh viên
                      </Link>
                    ...
                    <li>
                      <Link
                        href="/products/laptop-doanh-nghiep"
                        className="hover:text-red-500 hover:translate-x-1 inline-block transition-all duration-300"
                      >
                        Laptop Doanh nghiệp
                      </Link>
                ...
                {/* Row 2: Shipping Units, Payment Methods, App Store */}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <div className="bg-white/10 rounded p-1 hover:bg-white/20 transition-colors">
                      <GHNIcon className="h-5" />
                    </div>
                    <div className="bg-white/10 rounded p-1 hover:bg-white/20 transition-colors">
                      <GrabIcon className="h-5" />
                    </div>
                    <div className="bg-white/10 rounded p-1 hover:bg-white/20 transition-colors">
                      <ViettelPostIcon className="h-5" />
                    </div>
                    <div className="bg-white/10 rounded p-1 hover:bg-white/20 transition-colors">
                      <NinjaVanIcon className="h-5" />
                    </div>
                    <div className="bg-white/10 rounded p-1 hover:bg-white/20 transition-colors">
                      <AhamoveIcon className="h-5" />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <div className="bg-white/10 rounded p-1 hover:bg-white/20 transition-colors">
                      <MoMoIcon className="h-5" />
                    </div>
                    <div className="bg-white/10 rounded p-1 hover:bg-white/20 transition-colors">
                      <VNPayIcon className="h-5" />
                    </div>
                  </div>
                </div>
