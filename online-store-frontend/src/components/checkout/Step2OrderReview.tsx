...
export function Step2OrderReview() {
  ...
  const handleApplyCoupon = async () => {
    ...
    if (!code) {
      setCouponError(t('coupon_empty_error', 'checkout'));
      return;
    }
    ...
    try {
      ...
      toast.success(t('coupon_apply_success', 'checkout'));
    } catch (error: any) {
      setCheckoutSummary(null);
      const message = getUserFriendlyErrorMessage(error, t) || t('coupon_apply_error_fallback', 'checkout');
  ...
  const handleRemoveCoupon = () => {
    ...
    toast.success(t('coupon_remove_success', 'checkout'));
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{t('review_customer_info_title', 'checkout')}</h2>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{t('review_shipping_address_title', 'checkout')}</h2>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{t('review_shipping_service_title', 'checkout')}</h2>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3 bg-white rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <p className="text-gray-700 font-medium">{t('review_carrier_label', 'checkout')}</p>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-white rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <p className="text-gray-700 font-medium">{t('review_service_label', 'checkout')}</p>
            </div>
            <p className="font-semibold text-gray-900">
          ...
          <div className="flex items-center justify-between p-3 bg-white rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <p className="text-gray-700 font-medium">{t('review_estimated_delivery_label', 'checkout')}</p>
            </div>
            <p className="font-semibold text-gray-900">
              {t('estimated_delivery', 'checkout').replace('{{days}}', formData.selectedShipping?.estimatedDays || '0')}
            </p>
          </div>
          <div className="flex items-center justify-between p-3 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-gray-700 font-medium">{t('review_shipping_fee_label', 'checkout')}</p>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{t('coupon_title', 'checkout')}</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4 items-end">
          <div>
            <Label htmlFor="coupon-code" className="text-base font-medium mb-2 block">
              {t('coupon_enter_code', 'checkout')}
            </Label>
            <Input
              id="coupon-code"
              value={couponCode}
              ...
              placeholder={t('coupon_placeholder', 'checkout')}
          ...
          >
            {isCouponApplying ? t('coupon_applying', 'checkout') : t('coupon_apply_button', 'checkout')}
          </Button>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">{t('review_order_details_title', 'checkout')}</h2>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        <div className="flex justify-between gap-4">
          ...
          >
            {isLoading ? t('checkout_processing', 'checkout') : t('checkout_continue_payment', 'checkout')}
          </Button>
        </div>
      </div>
    </div>
