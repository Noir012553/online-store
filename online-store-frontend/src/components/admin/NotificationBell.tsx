                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-2 flex items-center justify-between">
                            <span className={`text-xs font-semibold px-2 py-1 rounded ${
                              ...
                              {status === 'pending_payment' ? t('pending_payment') : t('waiting_delivery', 'notifications')}
                            </span>
              ...
              <div className="space-y-4">
                  ...
                  <div className="rounded-lg border border-gray-200 p-3">
                    ...
                    <p className="mt-1 font-semibold text-gray-900">
                      {(() => {
                        ...
                        if (status === 'pending_payment') return t('pending_payment');
                ...
                <div className={`rounded-lg border p-3 transition-colors ${hasStatusChanged ? 'border-blue-300 bg-blue-50' : 'border-gray-200'}`}>
                  ...
                  >
                    ...
                    <option value="delivered">{t('my_orders_status_delivered')}</option>
                  </select>
                </div>
              </div>
