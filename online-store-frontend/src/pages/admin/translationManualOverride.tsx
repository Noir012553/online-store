...
import { Save, X, Check, AlertCircle, Eye, EyeOff, ArrowRight } from 'lucide-react';
...
const TranslationManualOverride = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const response = await fetch('/api/translations/admin/manual-override', {
        method: 'POST',
        headers: {
          ...
          {showPreview && (
            <div className="override-preview">
              ...
              <div className="override-preview-change">
                ...
                <div className="override-preview-arrow"><ArrowRight className="h-5 w-5" aria-hidden="true" /></div>
