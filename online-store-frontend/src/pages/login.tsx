...
export default function Login() {
  ...
  const processedOAuthCallback = useRef<string | null>(null);
  ...
  useEffect(() => {
    if (!router.isReady || router.query.oauth !== 'google') return;

    const callbackId = router.asPath;
    if (processedOAuthCallback.current === callbackId) return;

    processedOAuthCallback.current = callbackId;
  ...
  }, [router.isReady, router.query.oauth, router.asPath, googleLogin, router, from, t]);
