      ...
      <section className="bg-linear-to-r from-red-600 to-red-800 py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            {/* THAY ĐỔI: Sửa đường dẫn từ link sang /public/assets/policies/warranty-hero.png */}
            <div className="hidden md:block">
              <img
                src="https://images.unsplash.com/photo-1607550963587-4ba9a1dfa76b?w=500&h=400&fit=crop"
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 flex justify-center">
          <div className="max-w-4xl w-full">
            {/* THAY ĐỔI: Sửa đường dẫn từ link sang /public/assets/policies/warranty-details.png */}
            <div className="mb-12 bg-white rounded-lg overflow-hidden shadow-md">
              <img
                src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=900&h=400&fit=crop"
