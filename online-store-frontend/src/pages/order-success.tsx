...
import { CheckCircle, ShoppingBag, DollarSign, Package, Truck, Calendar } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-base font-semibold text-gray-900">
                  {getPaymentMethodName(newOrder.paymentMethod)}
                </p>
              </div>
              ...
              <div>
                ...
                <div className="mb-4">
                  <Badge className={`${getStatusBadgeColor(newOrder.isPaid, newOrder.isDelivered)}`}>
                    {getStatusText(newOrder.isPaid, newOrder.isDelivered)}
                  </Badge>
                </div>
