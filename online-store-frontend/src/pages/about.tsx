...
interface AboutMedia {
  team: Array<{ key: string; url: string | null; srcSet: string }>;
  hero: { url: string | null; poster: string | null };
}
...
function AboutContent() {
  ...
  const [aboutMedia, setAboutMedia] = useState<AboutMedia | null>(null);
  ...
  const team = [
    { nameKey: "team_member_1", roleKey: 'team_member_1_role', mediaKey: 'team-1' },
    { nameKey: "team_member_2", roleKey: 'team_member_2_role', mediaKey: 'team-2' },
    { nameKey: "team_member_3", roleKey: 'team_member_3_role', mediaKey: 'team-3' },
    { nameKey: "team_member_4", roleKey: 'team_member_4_role', mediaKey: 'team-4' },
  ];
