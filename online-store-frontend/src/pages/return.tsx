  ...
  useEffect(() => {
    const processPaymentReturn = async () => {
      try {
        ...
        const response = await orderAPI.getOrder(orderId, locale, getIntlLocale(locale), currencyCode);
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between py-3 border-b border-gray-200">
                    ...
                    <span className="font-semibold text-lg text-red-600">
                      {orderDetails.formattedTotalPrice}
                    </span>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="text-sm text-yellow-700">
                      ...
                      <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>{t('cod_next_step_2', 'payment')}<span className="font-bold text-red-600">{orderDetails?.formattedTotalPrice}</span></li>
