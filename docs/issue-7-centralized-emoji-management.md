...
- **Đã xác thực:** frontend `npm run check:emoji` và `npm run build` đều thành công. `npm test` vẫn thất bại tại test đa ngôn ngữ do module `../lib/i18n/types` không tồn tại; đây là lỗi có sẵn, ngoài phạm vi quản lý emoji.
