...
- Các hạng mục còn lại vẫn tập trung ở contract error có cấu trúc cho payment, shipment, translation, user, currency, import/export và email; không tự thay đổi hàng loạt vì các response này cần kiểm thử API theo từng luồng.
