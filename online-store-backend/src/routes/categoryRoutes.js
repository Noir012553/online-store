...
const { getCategoryTranslations } = require('../controllers/translationController');
...
/**
 * GET /api/categories/:id/translations - Lấy bản dịch danh mục theo ngôn ngữ
...
/**
 * DELETE /api/categories/:id/hard - Xóa cứng danh mục (Admin only)
 */
router.route('/:id/hard')
  .delete(protect, admin, hardDeleteCategory);
