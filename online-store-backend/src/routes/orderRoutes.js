...
/**
 * POST /api/orders/summary - Tính lại giỏ hàng và checkout theo dữ liệu tin cậy
 * @access Private
 */
router.post('/summary', protect, validateCheckoutSummary, handleValidationErrors, getOrderSummary);
