 ...
 */
router.post('/admin/create', protect, superAdmin, createUserByAdmin);
...
/**
 * PUT /api/users/avatar - Upload user avatar (local storage)
 * @body file - Image file (multipart/form-data)
 * @access Private
 */
router.put('/avatar', protect, uploadLocal.single('avatar'), uploadUserAvatar);
 ...
 */
router.put('/:id/restore', protect, superAdmin, restoreUser);
