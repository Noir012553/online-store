...
router.post('/', protect, admin, uploadLimiter, uploadMemory.single('image'), validateImageUpload, createBanner);
...
router.put('/:id', protect, admin, uploadLimiter, uploadMemory.single('image'), validateImageUpload, updateBanner);
