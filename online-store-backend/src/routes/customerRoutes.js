...
/**
 * GET /api/customers/phone/:phone - Lấy khách hàng theo số điện thoại (Public)
 * POST /api/customers/phone/:phone - Tạo/cập nhật khách hàng theo phone (Public, upsert)
 */
router.route('/phone/:phone')
  .get(getCustomerByPhone)
  .post(createOrUpdateCustomerByPhone);
