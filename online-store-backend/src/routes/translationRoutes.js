...
router.get(
  ...
  protect,
  admin,
  translationController.exportProductTranslationCache
);
...
router.post(
  ...
  protect,
  admin,
  translationController.importProductTranslationCache
);
...
router.post(
  '/admin/regenerate-product-cache',
  protect,
  admin,
  translationController.regenerateProductCache
);
