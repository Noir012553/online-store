...
class CouponFactory {
  ...
  static create(overrides = {}, productIds = [], categoryIds = [], index = 0) {
    ...
    const coupons = [
      ...
      {
        code: 'AUTUMN10',
        description: 'Autumn sale - 10% off',
        discountType: 'percentage',
        discountValue: 10,
        maxUses: 75,
      ...
      {
        code: 'GAMER25',
        description: 'Gaming gear promotion - 25% off',
        discountType: 'percentage',
        discountValue: 25,
        maxUses: 40,
      ...
      {
        code: 'TECHDAY30',
        description: 'Technology day - 30% off',
        discountType: 'percentage',
        discountValue: 30,
        maxUses: 25,
      ...
      {
        code: 'LAPTOP80',
        description: 'Laptop special - 80k off',
        discountType: 'fixed',
        discountValue: 80000,
        maxUses: 90,
      ...
      {
        code: 'WEEKEND12',
        description: 'Weekend offer - 12% off',
        discountType: 'percentage',
        discountValue: 12,
        maxUses: 80,
        minOrderAmount: 1000000,
      ...
      {
        code: 'MEMBER5',
        description: 'Member benefit - 5% off',
        discountType: 'percentage',
        discountValue: 5,
        maxUses: 150,
        minOrderAmount: 500000,
      ...
      {
        code: 'NEWYEAR18',
        description: 'New year promotion - 18% off',
        discountType: 'percentage',
        discountValue: 18,
        maxUses: 45,
