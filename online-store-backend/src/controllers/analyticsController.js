...
const formatReportingProducts = async (products, reportingCurrency, lang) => {
  ...
  const convertedProducts = products.map((product) => ({
    ...product,
    displayPrice: convertOrderAmount(
      product.price,
  ...
  return Promise.all(convertedProducts.map((product) => formatReportingAmountFields(
    product,
    reportingCurrency,
    lang,
...
const getDashboardStats = asyncHandler(async (req, res) => {
  ...
  res.json(await formatReportingAmountFields(result, reportingCurrency, req.locale, [
...
const getRevenueTimeline = asyncHandler(async (req, res) => {
  ...
  res.json(result.map((item) => formatAmountFields(item, currency, req.locale, [
...
const getTopSellingProducts = asyncHandler(async (req, res) => {
  ...
  const reportingCurrency = await getReportingCurrency(req.query.currencyCode);
  res.json(await formatReportingProducts(result, reportingCurrency, req.locale));
});
...
const getDashboardData = asyncHandler(async (req, res) => {
  ...
  const [stats, recentOrders, topProducts] = await Promise.all([
    formatReportingAmountFields(result.stats, reportingCurrency, req.locale, [
      ['totalRevenue', 'formattedTotalRevenue'],
    ]),
    formatReportingOrders(result.recentOrders, reportingCurrency, req.locale),
    formatReportingProducts(result.topProducts, reportingCurrency, req.locale),
  ]);
...
const getSlowSellingProducts = asyncHandler(async (req, res) => {
  ...
  const reportingCurrency = await getReportingCurrency(req.query.currencyCode);
  res.json(await formatReportingProducts(
...
const getUnpaidOrders = asyncHandler(async (req, res) => {
  ...
  res.json(await formatReportingOrders(unpaidOrders || [], reportingCurrency, req.locale));
});
...
const getLowInventoryProducts = asyncHandler(async (req, res) => {
  ...
  res.json({
    data: await formatReportingProducts(await localizeProductCategories(processedProducts, lang), reportingCurrency, req.locale),
    pagination: {
      total,
      page,
      limit,
...
const getPaidOrders = asyncHandler(async (req, res) => {
  ...
  res.json({
    data: await formatReportingOrders(orders || [], reportingCurrency, req.locale),
    pagination: {
      total,
      page,
      limit,
...
const getUnusedCoupons = asyncHandler(async (req, res) => {
  ...
  res.json({
    data: await formatReportingCoupons(coupons || [], reportingCurrency, req.locale),
    pagination: {
      total,
      page,
      limit,
