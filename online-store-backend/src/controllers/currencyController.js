...
exports.createCurrency = async (req, res) => {
  ...
  try {
    ...
    if (!code || !name || !symbol) {
      ...
      if (!symbol) fields.push('symbol');
      return sendCurrencyError(res, 400, adminLang, {
        code: 'CURRENCY_REQUIRED_FIELDS',
        params: { fields },
      });
    }
    ...
    if (error.code === 11000) {
      ...
      error.params = { field: Object.keys(error.keyPattern || {})[0] || 'code' };
