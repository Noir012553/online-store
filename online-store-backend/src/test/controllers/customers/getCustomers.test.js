...
const { getCustomers, getCustomerById, createCustomer, updateCustomer, deleteCustomer, hardDeleteCustomer } = require('../../../controllers/customerController');
...
describe('Customer Controller - getCustomers', () => {
  ...
  it('should fetch all customers with pagination', async () => {
    ...
    expect(countDocumentsStub.calledOnceWithExactly({ isDeleted: false })).to.be.true;
