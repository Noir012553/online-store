...
describe('Category Controller - CRUD Operations', () => {
  ...
  describe('getCategoryById', () => {
    ...
    it('should overlay a successful translation for the requested locale', async () => {
      const categoryId = new mongoose.Types.ObjectId();
      const category = {
        _id: categoryId,
        name: 'Máy tính',
      ...
      await getCategoryById({ params: { id: categoryId.toString() }, lang: 'en' }, res);
