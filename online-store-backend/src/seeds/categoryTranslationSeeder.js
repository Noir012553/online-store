...
const TRANSLATIONS = {
  ...
  monitor: {
    vi: { name: 'Màn hình', description: 'Màn hình máy tính cho công việc, sáng tạo nội dung và giải trí' },
    en: { name: 'Monitor', description: 'Computer monitors for work, content creation and entertainment' },
    pt: { name: 'Monitor', description: 'Monitores para trabalho, criação de conteúdo e entretenimento' },
    fr: { name: 'Moniteur', description: 'Moniteurs pour le travail, la création de contenu et le divertissement' },
    de: { name: 'Monitor', description: 'Computermonitore für Arbeit, Content-Erstellung und Unterhaltung' },
    it: { name: 'Monitor', description: 'Monitor per lavoro, creazione di contenuti e intrattenimento' },
    es: { name: 'Monitor', description: 'Monitores para trabajo, creación de contenido y entretenimiento' },
    nl: { name: 'Monitor', description: 'Computermonitoren voor werk, contentcreatie en entertainment' },
    sv: { name: 'Bildskärm', description: 'Datormonitorer för arbete, innehållsskapande och underhållning' },
  },
  gaming_monitor: {
    vi: { name: 'Màn hình Gaming', description: 'Màn hình tần số quét cao dành cho gaming' },
    en: { name: 'Gaming Monitor', description: 'High refresh rate monitors designed for gaming' },
    pt: { name: 'Monitor Gamer', description: 'Monitores de alta taxa de atualização projetados para jogos' },
    fr: { name: 'Écran Gaming', description: 'Moniteurs à fréquence de rafraîchissement élevée conçus pour le gaming' },
    de: { name: 'Gaming-Monitor', description: 'Monitore mit hoher Bildwiederholrate fürs Gaming' },
    it: { name: 'Monitor da Gaming', description: 'Monitor ad alta frequenza di aggiornamento progettati per il gaming' },
    es: { name: 'Monitor Gaming', description: 'Monitores de alta frecuencia de actualización diseñados para gaming' },
    nl: { name: 'Gamingmonitor', description: 'Monitoren met hoge verversingssnelheid voor gaming' },
    sv: { name: 'Gamingskärm', description: 'Bildskärmar med hög uppdateringsfrekvens för gaming' },
  },
  audio: {
    vi: { name: 'Âm thanh', description: 'Thiết bị và phụ kiện âm thanh cho âm nhạc, công việc và gaming' },
    en: { name: 'Audio', description: 'Audio devices and accessories for music, work and gaming' },
    pt: { name: 'Áudio', description: 'Dispositivos e acessórios de áudio para música, trabalho e jogos' },
    fr: { name: 'Audio', description: 'Appareils et accessoires audio pour la musique, le travail et le gaming' },
    de: { name: 'Audio', description: 'Audiogeräte und Zubehör für Musik, Arbeit und Gaming' },
    it: { name: 'Audio', description: 'Dispositivi e accessori audio per musica, lavoro e gaming' },
    es: { name: 'Audio', description: 'Dispositivos y accesorios de audio para música, trabajo y gaming' },
    nl: { name: 'Audio', description: 'Audioapparaten en accessoires voor muziek, werk en gaming' },
    sv: { name: 'Ljud', description: 'Ljudenheter och tillbehör för musik, arbete och gaming' },
  },
};
