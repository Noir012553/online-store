...
const seedShippingProviders = async () => {
  ...
  if (existingGhn) {
    ...
    existingGhn.apiUrl = process.env.GHN_API_URL || 'https://dev-online-gateway.ghn.vn/shiip/public-api';
    ...
    console.log(`${CLI_SYMBOLS.info}  GHN provider configuration synchronized.`);
    return [existingGhn];
  }
