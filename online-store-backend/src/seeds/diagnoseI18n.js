...
const diagnose = async () => {
  try {
    ...
    const requiredLocales = [
      { code: 'vi', namespace: 'common' },
      { code: 'en', namespace: 'common' },
      { code: 'vi', namespace: 'products' },
      { code: 'en', namespace: 'products' },
    ];
    ...
    // ============ STEP 3: Check if footer keys exist in vi/common ============

    const viCommon = await StaticTranslation.findOne({
      code: 'vi',
      namespace: 'common',
    });
