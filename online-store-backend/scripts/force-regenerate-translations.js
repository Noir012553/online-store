 ...
 * 2. Gộp các bản ghi còn thiếu từ LiveTranslationCache → ProductCatalogTranslationCache
 * 3. Đảm bảo specTranslationSeeder chạy để aggregate mà không ghi đè cache hiện có
 * 
 * Cách dùng:
...
async function main() {
  try {
    ...
    console.log(`  Cache has ${cacheRecordCount} entries`);
