...
const checkedFiles = [
  ...
  'src/seeds/fixOrderCustomers.js',
  ...
  'src/scripts/translateApproveAll.js',
  ...
  'src/test/check-db-brands.test.js',
  'src/test/test-shadow-writes.test.js',
  'src/test/test-blueprint-3phase.test.js',
  'src/test/check-db-state.test.js',
  'src/test/check-brands.test.js',
  'src/test/test-translation-e2e.test.js',
  'src/test/test-language-sync.test.js',
  'src/scripts/fix-product-prices.js',
  'src/scripts/quick-generate-translations.js',
  'src/test/test-phase4-e2e-simplified.test.js',
