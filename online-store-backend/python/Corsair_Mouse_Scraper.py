...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Chuột Corsair
        url = f"https://gearvn.com/collections/chuot-corsair?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Chuột Corsair...")
    ...
    file_prefix = f"Corsair_Mouse_{date_str}"
