...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím Aula trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-aula?page={page}'
...
def scrape_full():
  print('>>> Bắt đầu quét danh sách Bàn phím Aula...')
  ...
  file_prefix = f'Aula_Keyboard_{date_str}'
