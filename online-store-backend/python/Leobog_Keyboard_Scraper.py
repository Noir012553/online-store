...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím Leobog trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-leobog?page={page}'
...
def scrape_full():
  print('>>> Bắt đầu quét danh sách Bàn phím Leobog...')
  ...
  file_prefix = f'Leobog_Keyboard_{date_str}'
