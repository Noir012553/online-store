...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Laptop Gaming HP
        url = f"https://gearvn.com/collections/laptop-gaming-hp?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách sản phẩm HP (Gaming)...")
    ...
    file_prefix = f"Hp_Laptop_Gaming_{date_str}"
