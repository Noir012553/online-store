...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Laptop Gaming Lenovo
        url = f"https://gearvn.com/collections/laptop-gaming-lenovo?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách sản phẩm Lenovo (Gaming)...")
    ...
    file_prefix = f"Lenovo_Laptop_Gaming_{date_str}"
