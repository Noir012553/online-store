...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Tai nghe Logitech
        url = f"https://gearvn.com/collections/tai-nghe-logitech?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Tai nghe Logitech...")
    ...
    file_prefix = f"Logitech_Headphone_{date_str}"
