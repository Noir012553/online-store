...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím Keychron trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-keychron?page={page}'
...
def scrape_full():
  print('>>> Bắt đầu quét danh sách Bàn phím Keychron...')
