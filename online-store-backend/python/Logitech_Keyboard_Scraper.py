...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím Logitech trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-logitech?page={page}'
...
def scrape_full():
  print('>>> Bắt đầu quét danh sách Bàn phím Logitech...')
  ...
  file_prefix = f'Logitech_Keyboard_{date_str}'
