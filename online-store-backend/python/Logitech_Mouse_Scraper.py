...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Chuột Logitech
        url = f"https://gearvn.com/collections/chuot-logitech?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Chuột Logitech...")
    ...
    file_prefix = f"Logitech_Mouse_{date_str}"
