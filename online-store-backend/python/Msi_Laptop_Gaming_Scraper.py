...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Laptop Gaming MSI
        url = f"https://gearvn.com/collections/laptop-msi-gaming?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách sản phẩm MSI (Gaming)...")
    ...
    file_prefix = f"Msi_Laptop_Gaming_{date_str}"
