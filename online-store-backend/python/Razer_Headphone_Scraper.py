...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Tai nghe Razer
        url = f"https://gearvn.com/collections/tai-nghe-razer?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Tai nghe Razer...")
    ...
    file_prefix = f"Razer_Headphone_{date_str}"
