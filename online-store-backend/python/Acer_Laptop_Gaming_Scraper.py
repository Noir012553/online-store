...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Laptop Gaming Acer
        url = f"https://gearvn.com/collections/laptop-gaming-acer?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách sản phẩm Acer (Gaming)...")
    ...
    file_prefix = f"Acer_Laptop_Gaming_{date_str}"
