...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím cơ FL-Esports trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-co-fl-esports?page={page}'
...
def scrape_full():
  print('>>> Bắt đầu quét danh sách Bàn phím cơ FL-Esports...')
  ...
  file_prefix = f'FLEsports_Keyboard_{date_str}'
