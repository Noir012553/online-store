...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Tai nghe Edifier
        url = f"https://gearvn.com/collections/tai-nghe-edifier?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Tai nghe Edifier...")
    ...
    file_prefix = f"Edifier_Headphone_{date_str}"
