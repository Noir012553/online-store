...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Chuột Razer
        url = f"https://gearvn.com/collections/chuot-razer?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Chuột Razer...")
    ...
    file_prefix = f"Razer_Mouse_{date_str}"
