...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím Dare-U trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-dare-u?page={page}'
...
def scrape_full():
  print('>>> Bắt đầu quét danh sách Bàn phím Dare-U...')
  ...
  file_prefix = f'DareU_Keyboard_{date_str}'
