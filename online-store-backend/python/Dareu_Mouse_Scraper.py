...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Chuột DareU
        url = f"https://gearvn.com/collections/chuot-dare-u?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Chuột DareU...")
    ...
    file_prefix = f"Dareu_Mouse_{date_str}"
