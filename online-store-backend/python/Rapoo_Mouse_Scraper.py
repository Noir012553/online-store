...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Chuột Rapoo
        url = f"https://gearvn.com/collections/chuot-rapoo?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Chuột Rapoo...")
    ...
    file_prefix = f"Rapoo_Mouse_{date_str}"
