...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím ASUS trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-asus?page={page}'
...
def scrape_full():
  print('>>> Bắt đầu quét danh sách Bàn phím ASUS...')
  ...
  file_prefix = f'ASUS_Keyboard_{date_str}'
