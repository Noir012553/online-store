...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Chuột Asus
        url = f"https://gearvn.com/collections/chuot-asus?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Chuột Asus...")
    ...
    file_prefix = f"Asus_Mouse_{date_str}"
