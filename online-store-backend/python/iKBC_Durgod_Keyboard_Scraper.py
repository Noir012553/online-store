...
def get_all_collection_urls():
  ...
  page = 1
  while True:
    # URL danh mục Bàn phím iKBC & Durgod trên GearVN
    url = f'https://gearvn.com/collections/ban-phim-ikbc-durgod?page={page}'
...
def scrape_full():
  ...
  file_prefix = f'iKBC_Durgod_Keyboard_{date_str}'
