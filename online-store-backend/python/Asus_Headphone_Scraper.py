...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Tai nghe Asus
        url = f"https://gearvn.com/collections/tai-nghe-asus?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách Tai nghe Asus...")
    ...
    file_prefix = f"Asus_Headphone_{date_str}"
