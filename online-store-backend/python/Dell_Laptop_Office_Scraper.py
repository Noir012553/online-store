...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Dell học tập và làm việc
        url = f"https://gearvn.com/collections/laptop-dell-hoc-tap-va-lam-viec?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách sản phẩm Dell (Học tập & Làm việc)...")
    ...
    file_prefix = f"Dell_Laptop_Office_{date_str}"
