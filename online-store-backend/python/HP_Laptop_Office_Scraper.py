...
def get_all_collection_urls():
    ...
    page = 1
    while True:
        # URL danh mục Laptop HP Pavilion
        url = f"https://gearvn.com/collections/laptop-hp-pavilion?page={page}"
...
def scrape_full():
    print(">>> Bắt đầu quét danh sách sản phẩm HP Office...")
    ...
    # ĐỔI TÊN FILE THÀNH HP_Laptop_Office
    file_prefix = f"HP_Laptop_Office_{date_str}"
